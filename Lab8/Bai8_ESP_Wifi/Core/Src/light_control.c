...
void test_Esp(){
	...
	if(uart_EspCheck() == 0) {
		...
		lcd_Fill(0, 0, 240, 40, BLUE);
		lcd_ShowStr(40, 5, "MONITOR SCREEN", WHITE, BLUE, 24, 0);

		lcd_ShowStr(10, 60, "ESP:", BLACK, WHITE, 24, 0);
		lcd_ShowStr(100, 60, "CONNECTED", GREEN, WHITE, 24, 0);

		lcd_DrawRectangle(10, 100, 230, 200, CYAN);
		lcd_ShowStr(20, 120, "Current Temp:", YELLOW, WHITE, 24, 0);
