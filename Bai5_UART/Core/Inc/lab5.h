...
#define TIMEOUT_DURATION 10000 // 10 seconds
#define TIMEOUT_TICK (TIMEOUT_DURATION / DURATION) // 100000/ 50 = 200 ticks
#define MAX_RESPONSE_SIZE 10
#define MAX_RESENT_TIMEOUT 3
